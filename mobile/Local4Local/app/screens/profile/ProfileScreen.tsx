...
import { HeaderRight, headerOptions } from "../../components/header/GlobalHeader";
...
export function Profile({ navigation }: { navigation: any }) {
  ...
  const onLogout = async () => {
    await clearToken();
    const newState = { token: null, authenticated: false, accountDeleted: false };
