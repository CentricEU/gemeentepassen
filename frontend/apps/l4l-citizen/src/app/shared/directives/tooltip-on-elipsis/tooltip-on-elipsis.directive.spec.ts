// Todo: removed the directive after migrating all the project to standalone
...
@Component({
	standalone: false,
	template: `<div [appTooltipOnEllipsis]="tooltipText" windmillTooltip>Test content</div>`,
})
...
describe('TooltipOnEllipsisDirective', () => {
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			...
			imports: [TooltipOnEllipsisDirective, MockWindmillTooltipDirective],
