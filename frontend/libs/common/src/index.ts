...
export * from './lib/_enums/grant-holder.enum';
...
/** Models  */
export * from './lib/_models/assign-passholder-grants.model';
...
export * from './lib/_models/grant-dto.model';
...
export * from './lib/_services/grant.service';
